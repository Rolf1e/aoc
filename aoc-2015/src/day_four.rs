...
pub mod test_2015_day_four {
    use crate::day_four::find_md5;

    // === Part one ===
    // #[test]
    pub fn should_be_609043() {
        assert_eq!(609043, find_md5("abcdef"));
    }

    // #[test]
    pub fn should_be_1048970() {
        assert_eq!(1048970, find_md5("pqrstuv"));
    }
    
    // #[test]
    pub fn should_treat_input_1() {
        assert_eq!(346386, find_md5("iwrupvqb"));
    }
